...
def check_syntax():
    ...
    files = [
        "textgraphtree/models/partitioner/hierarchical_partitioner.py",
        "textgraphtree/models/generator/tree_generator.py",
        "textgraphtree/templates/generation/hierarchical_generation.py",
    ]
...
def check_imports():
    ...
    try:
        ...
        from textgraphtree.templates import HIERARCHICAL_GENERATION_PROMPT
...
def check_registration():
    ...
    try:
        ...
        with open("textgraphtree/operators/partition/partition_kg.py", "r") as f:
            content = f.read()
        ...
        with open("textgraphtree/operators/generate/generate_qas.py", "r") as f:
            content = f.read()
...
async def test_partitioner():
    ...
    from textgraphtree.models import HierarchicalPartitioner
...
def test_generator():
    ...
    from textgraphtree.models import TreeStructureGenerator
