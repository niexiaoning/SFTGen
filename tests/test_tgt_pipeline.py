"""
Tests for TGT Phase 3: Critic and Pipeline Integration.

Tests cover:
- RuleCritic: built-in rules, custom rules, scoring
- LLMCritic: response parsing, validation with mock LLM
- TGTPipeline: end-to-end generation with all layers mocked
"""
...
from textgraphtree.bases.base_critic import CriticResult
    ...
    def test_pipeline_run(self):
        async def _run():
            ...
            for qa in results:
                ...
                assert qa["metadata"]["pipeline"] == "tgt"
