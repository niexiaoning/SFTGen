...
async def search_all(
    ...
    for search_type in search_types:
        if search_type == "wikipedia":
            from textgraphtree.models import WikiSearch
            from textgraphtree.operators.search.kg.search_wikipedia import search_wikipedia
            ...
            from textgraphtree.models import GoogleSearch
            from textgraphtree.operators.search.web.search_google import search_google
            ...
            from textgraphtree.models import BingSearch
            from textgraphtree.operators.search.web.search_bing import search_bing
            ...
            # from textgraphtree.models import UniProtSearch
            # from textgraphtree.operators.search.db.search_uniprot import search_uniprot
            #
