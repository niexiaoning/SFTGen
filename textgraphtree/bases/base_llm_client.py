...
from textgraphtree.bases.base_tokenizer import BaseTokenizer
...
class BaseLLMClient(abc.ABC):
    ...
    def __init__(
        ...
        *,
        ...
        max_tokens: int = 4096,  # pragma: allowlist secret
        ...
        **kwargs: Any,
        ...
        self.max_tokens = max_tokens  # pragma: allowlist secret
