...
from textgraphtree.models.partitioner.bfs_partitioner import BFSPartitioner
...
class ECEPartitioner(BFSPartitioner):
    ...
    def _sort_units(units: list, edge_sampling: str) -> list:
        ...
        :param edge_sampling: edge sampling strategy (random, min_loss, max_loss)  # pragma: allowlist secret
        :return: sorted units
        """
        ...
        elif edge_sampling == "max_loss":  # pragma: allowlist secret
            units = sorted(
                units,
                key=lambda x: x[-1]["loss"],
                reverse=True,
    ...
    async def partition(
        ...
        max_tokens_per_community: int = 10240,  # pragma: allowlist secret
        ...
        async def _grow_community(
            ...
            while not queue.empty():
                if (
                    ...
                    or token_sum >= max_tokens_per_community  # pragma: allowlist secret
                ):
                    break
