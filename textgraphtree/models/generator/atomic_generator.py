...
from textgraphtree.templates import (
    ...
    def build_prompt(
        ...
        if self.chinese_only:
            if self.use_multi_template:
                from textgraphtree.templates import ATOMIC_GENERATION_PROMPT_VARIANTS_CHINESE_ONLY
                if "zh" in ATOMIC_GENERATION_PROMPT_VARIANTS_CHINESE_ONLY:
                    ...
                    from textgraphtree.templates import ATOMIC_GENERATION_PROMPT_CHINESE_ONLY
...
class AtomicQuestionGenerator(AtomicGenerator):
    ...
    def build_prompt(
        ...
        # Use Chinese-only templates if enabled
        if self.chinese_only:
            from textgraphtree.templates import ATOMIC_QUESTION_PROMPT_CHINESE_ONLY
