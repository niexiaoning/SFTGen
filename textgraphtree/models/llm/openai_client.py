...
class OpenAIClient(BaseLLMClient):
    ...
    def _pre_generate(self, text: str, history: List[str]) -> Dict:
        kwargs = {
            ...
            "top_p": self.top_p,
            "max_tokens": self.max_tokens,  # pragma: allowlist secret
        }
        if self.seed:
    ...
    async def generate_topk_per_token(
        ...
        **extra: Any,
        ...
        # Limit max_tokens to 1 to avoid long completions  # pragma: allowlist secret
        kwargs["max_tokens"] = 1  # pragma: allowlist secret
    ...
    async def generate_answer(
        ...
        **extra: Any,
        ...
        estimated_tokens = prompt_tokens + kwargs["max_tokens"]  # pragma: allowlist secret
