...
from textgraphtree.bases.base_storage import StorageNameSpace
...
from textgraphtree.operators import (
    build_mm_kg,
    build_text_kg,
...
from textgraphtree.utils import async_to_sync_method, compute_mm_hash, logger
...
class TextGraphTree:
    ...
    def __post_init__(self):
        self.tokenizer_instance: Tokenizer = self.tokenizer_instance or Tokenizer(
            model_name=os.getenv("TOKENIZER_" + "MODEL")  # pragma: allowlist secret
        )
        ...
        self.qa_storage: JsonListStorage = JsonListStorage(
            os.path.join(self.working_dir, "data", "textgraphtree", f"{self.unique_id}"),
            namespace="qa",
        )
    ...
    async def generate_evaluation(self, partition_config: Dict, evaluation_config: Dict):
        ...
        """
        from textgraphtree.operators.evaluate import (
