  ...
  <el-container class="layout-container">
      ...
      <div class="header-right">
        ...
        >
          ...
          <el-sub-menu v-if="authStore.isAdmin" index="/config">
            ...
            <el-menu-item index="/config/tgt">TGT配置</el-menu-item>
          </el-sub-menu>
          <el-sub-menu v-if="authStore.isAdmin" index="/tgt">
            <template #title>
              <el-icon><Grid /></el-icon>
              <span>TGT</span>
            </template>
            <el-menu-item index="/tgt/taxonomies">意图树管理</el-menu-item>
            <el-menu-item index="/tgt/pipeline">TGT管道</el-menu-item>
          </el-sub-menu>
    ...
    <!-- <el-footer class="layout-footer">
      <div class="footer-content">
        <span>TextGraphTree v2.0.0 © 2025</span>
        <div class="footer-links">
          <a href="https://github.com/open-sciencelab/TextGraphTree" target="_blank">GitHub</a>
