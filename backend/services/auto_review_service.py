...
from textgraphtree.models import OpenAIClient
...
"""
    ...
    def _get_llm_client(self) -> OpenAIClient:
        """获取LLM客户端"""
        try:
            from textgraphtree.models.tokenizer.tiktoken_tokenizer import TiktokenTokenizer
            tokenizer = TiktokenTokenizer(model_name="cl100k_base")
            
            from textgraphtree.models.llm.llm_env import parse_extra_body_json_strings
